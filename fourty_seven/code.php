<?php
    /**
     * 绘制验证码
     *    需要下面几个元素：   1.宽  高  字母 数字 字母数字混合   干扰线 干扰点  背景色  字体的颜色
     *
     *
     *
     */
    ...
    function verify($width = 100, $height = 40 ,$num = 5,$type = 1){
       //1.准备画布
        ...
        switch ($type){
            ...
            case 3:
                //0-9 a-z  A_Z
                $str = '123456789abcdefghgklmnopqrstuvwxyzABCDEFGHGKLMNOPQRSTUVWSYZ';
                $string = substr(str_shuffle($str),0,$num);
                break;
            default;
        }
    ...
    function deepColor($image){
        return  imagecreatetruecolor($image,mt_rand(0,120),mt_rand(0,120),mt_rand(0,120));
    }